...
public class MAAutobanco extends Ventana{
    
   JPanel panelli;
    JLabel lsaludo;
    JTextField lid, lnombre, ldireccion, ltelefono, lnum_cajas, lnum_escritorios, lefectivo, lnum_autobancos;
    JComboBox lista;
...
//       panelli.setLayout(new BoxLayout(panelli, BoxLayout.Y_AXIS));
      ...
      public void actionPerformed(ActionEvent actionEvent) {
       ...
       lid.setText(String.valueOf(aautobancos[posicion].id));
       lnombre.setText(String.valueOf(aautobancos[posicion].nombre));
       ldireccion.setText(String.valueOf(aautobancos[posicion].direccion));
       ltelefono.setText(String.valueOf(aautobancos[posicion].telefono));
       lnum_cajas.setText(String.valueOf(aautobancos[posicion].num_cajas));
       lnum_escritorios.setText(String.valueOf(aautobancos[posicion].num_escritorios));
       lnum_autobancos.setText(String.valueOf(aautobancos[posicion].num_autobancos));
       lefectivo.setText(String.valueOf(aautobancos[posicion].efectivo));
      }
    };
     ...
     //   JLabel lid, lnombre, lapellido, ldireccion, ltelefono;
        ...
        lnum_autobancos = new JTextField();
        ...
        JLabel nauto = new JLabel("Autobancos");
        ...
        lnum_autobancos.setBounds(370, 300, 150, 30);
       ...
       lid.setEditable(false); 
        lnombre.setEditable(false);        
                ...
                lnum_autobancos.setEditable(false);
    ...
    private void eventoAgregar() {
        ...
        lnum_autobancos.setEditable(true);
        } else {
    ...
    private void eventoOk() {
        ...
        ActionListener oyente = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                MisAutobancos auxiliar = new MisAutobancos((posicion+1), lnombre.getText(), 
                        ldireccion.getText() ,ltelefono.getText(),lnum_cajas.getText(),
                        lnum_escritorios.getText(),lnum_autobancos.getText() ,lefectivo.getText());

                
                
                BancoIPC.aautobancos[posicion] = auxiliar;
